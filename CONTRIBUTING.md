...
This outlines how to propose a change to citesperu. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/citesperu", fork = TRUE)`.
...
Please note that the citesperu project is released with a [Contributor
Code of
Conduct](https://paulesantos.github.io/citesperu/CODE_OF_CONDUCT.md). By
