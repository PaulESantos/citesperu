...
Thanks for using citesperu! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/PaulESantos/citesperu/issues/new).
...
requests](https://github.com/PaulESantos/citesperu/issues) to make sure
