...
[citesperu](https://github.com/PaulESantos/citesperu) despliega un
banner informativo al estilo de
[tidyverse](https://tidyverse.tidyverse.org) resumiendo las bases
...
Contexto CITES en el
Perú](https://paulesantos.github.io/citesperu/docs/CONTEXTO_CITES_PERU.md).
...
[`cites_match()`](https://paulesantos.github.io/citesperu/reference/cites_match.md)
acepta directamente `data.frame` o `tibble`, facilitando la limpieza de
inventarios biológicos o registros aduaneros:
...
[MIT](https://paulesantos.github.io/citesperu/LICENSE.md).
